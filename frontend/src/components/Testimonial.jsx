...
function Testimonial() {
  return (
    <section className='w-screen bg-white flex items-center justify-center py-5'>
        <div className="w-4/12 bg-[#A10550] h-48 text-white px-5 flex flex-col  justify-center">
        ...
        <div className='w-4/12 h-48 bg-cover' style={{ backgroundImage: `url(${Girls})` }}></div>
    </section>
  )
}
